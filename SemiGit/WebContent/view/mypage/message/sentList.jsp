            ...
            <table class="table table-striped">
              <thead>
                <tr>
	              ...
	              <tbody>
	                <tr>
	                  <td>${msgList.get(i).getU_name }</td>
	                  <td>${msgList.get(i).getM_comment }</td>
	                  <c:if test="${msgList.get(i).getM_read }==y"><td style="color: #355C7D;">확인</td></c:if>
	                  <c:if test="${msgList.get(i).getM_read }==n"><td style="color: #C06C84;">미확인</td></c:if>
