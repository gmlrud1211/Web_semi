...
public class StudyFilterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int st_code = (int)session.getAttribute("st_code");
...
//		System.out.println("받아온 값 출력"+selRegion+time+gender);
...
//		System.out.println("스터디필터"+studyFilter);
...
//		Study study = studyService.getConditionedParam(request, response);
