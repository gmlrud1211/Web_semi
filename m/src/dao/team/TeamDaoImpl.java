...
public class TeamDaoImpl implements TeamDao{
	...
	public List selectTeammate(int study_no) {
		...
		sql+=" and s.ss_statecode=3";
		sql+=" and s.ss_yesno='N'";
		sql+=" and s.study_no=?";
	...
	public Study selectStudy(int study_no) {
		String sql = "";
		sql += "SELECT S.study_no, S.st_code, S.study_name, S.study_region, S.study_details, S.study_period, F.file_storedname,";
